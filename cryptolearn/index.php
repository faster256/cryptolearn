...
<div class="grid md:grid-cols-4 gap-8">
  <section class="md:col-span-2 bg-white border border-gray-100 rounded p-6">
    ...
    <div class="flex space-x-3">
      <a href="/register.php" class="px-4 py-2 bg-blue-600 text-white rounded" data-i18n="btn_start">Почати</a>
      <a href="/courses/basics.php" class="px-4 py-2 border rounded text-sm">Курси</a>
    </div>
  </section>
